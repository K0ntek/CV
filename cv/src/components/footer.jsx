       ...
       <div>
         <div className="bg-[#050505] py-[50px]">
            <div className="text-white text-center py-[10px]">
                <h1 className="text-[40px] font-gruppo text-transparent bg-clip-text bg-gradient-to-r from-[#45a2ff] to-[#1282f1]">JAKUB KONTEK</h1>
                <p className="text-[20px] font-gruppo w-[60%] md:w-[40%] mx-auto text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum deleniti ex quibusdam esse eius aut, quia a quaerat eaque neque illo corrupti placeat minima autem nihil eum amet nesciunt doloremque.</p>
            </div>
            <div className="flex space-x-[10px] text-white py-[5px] justify-center">
                <a href="https://www.facebook.com/profile.php?id=100009894456441"><BsFacebook className="text-[30px] hover:text-[#45a2ff] transition-all duration-300"/></a>
