...
const VerticalBlocks=()=>{
    ...
    return(
        <div className="elements grid grid-cols-4 w-[90%] mx-auto overflow-hidden">
            ...
            <div className="element w-full mx-auto h-[60%] bg-gradient-to-t from-white to-black"></div>
        </div>
